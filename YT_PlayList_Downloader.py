...
class YouTubeDownloaderApp(ctk.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.link_entry = ctk.CTkEntry(self, placeholder_text="    ...... <  Youtube links only  > ......")
        self.link_entry.grid(row=0, column=1, padx=10, pady=15, sticky="ew", columnspan=2)
        
        self.input_label = ctk.CTkLabel(self, text="Paste link here  >>>", font=("",14))
        ...
        self.download_button_video = ctk.CTkButton(self, height=35, text="Download Playlist (Video)", font=("", 15),fg_color="#1985a1",command=self.download_playlist_video)
        self.download_button_video.grid(row=1, column=0, padx=15, pady=5, sticky="ew")

        # Create a download button for audio
        self.download_button_audio = ctk.CTkButton(self, height=35, text="Download Playlist (Audio)", font=("", 15),fg_color="#1985a1", command=self.download_playlist_audio)
        self.download_button_audio.grid(row=2, column=0, padx=15, pady=5, sticky="ew")
        
        # Create a button for single video download
        self.download_button_single_video = ctk.CTkButton(self, height=35, text="Download Video", font=("", 15),fg_color="#1985a1", command=self.download_single_video)
        self.download_button_single_video.grid(row=1, column=2, padx=15, pady=5, sticky="ew")

        # Create a button for single audio download
        self.download_button_single_audio = ctk.CTkButton(self, height=35, text="Download Audio", font=("", 15),fg_color="#1985a1", command=self.download_single_audio)
        ...
        self.clear_text_button = ctk.CTkButton(self, text="Clear Text Box",fg_color="#1985a1",corner_radius=50, command=self.clear_text_box)
        ...
        self.browse_button = ctk.CTkButton(self ,text="Download path",fg_color="#1985a1",corner_radius=50, command=self.browse_path)
